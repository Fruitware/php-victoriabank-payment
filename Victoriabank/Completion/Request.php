...
class Completion_Request extends Request{
    ...
    public function init()
    {
        ...
        #Set TRX type
        $this->_requestFields[self::TRTYPE] = VictoriaClient::TRX_TYPE_COMPLETION;
    ...
    public function validateRequestParams()
    {
        ...
        if (!isset($this->_requestFields[self::INT_REF]) || strlen($this->_requestFields[self::INT_REF]) < 1 || strlen($this->_requestFields[self::INT_REF]) > 32)
